              ...
              <ul className="w-full flex-col items-start">
                {navLinks.slice(0, 9).map((link) => (
                  ...
                  >
                    ...
                    >
                      <span className="relative justify-around w-full flex items-center min-h-fit px-4 rounded-full before:absolute before:inset-0 before:opacity-0 before:transition-opacity before:duration-500 before:content-[''] group-hover:before:opacity-100 overflow-hidden">
                        {link.icon && (
                          <Image
                            src={link.icon}
                            alt="logo"
                          ...
                          <div className="flex justify-center items-center h-5 w-5 p-0.5">
                            <Image
                              ...
                              className={`object-contain ${
                                link.name === "LinkedIn" ? "size-6" : "size-44"
                              } z-10`}
                            />
                          </div>
                        )}
