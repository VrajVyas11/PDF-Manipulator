          ...
          <SheetContent className='sheet-content min-h-screen   border-2 bg-opacity-80 border-s2 bg-black shadow-md shadow-purple-200/50  sm:w-64 '>
            ...
            <SheetTitle className="text-lg font-bold">Menu</SheetTitle>
              ...
              <ul className="w-full flex-col items-start gap-2 ">
                    ...
                    <ul className=" flex flex-col px-3 gap-2 justify-center items-center">
                            ...
                            return (
                                ...
                                >
                                    <button
                                        ...
                                        className={`relative  w-full gap-3 shadow-400  rounded-full flex flex-row justify-start items-center group`}
                                    >
                                        <span
