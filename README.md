...
| 🖊️ **PDF Editor** | ![PDF Editor](./livedemoimages/4.png) ![PDF Editor](./livedemoimages/5.png) - Modify PDFs using an editor, accessible on all devices. |
| 📝 **PDF Annotator** | ![PDF Annotator](./livedemoimages/6.png) ![PDF Annotator](./livedemoimages/7.png) - Annotate PDFs with highlights, notes, and drawings using an embed PDF annotator, responsive across devices. |
...
- [embedpdf](https://embedpdf.com/) for PDF annotation functionality.
