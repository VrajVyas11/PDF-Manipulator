...
const PdfMerge = () => {
  ...
  return (
    ...
    <h2 className="text-white text-3xl  rounded-b-none border-[1px] border-gray-200   text-center  p-5  h-fit w-full backdrop-blur-lg  bg-opacity-90  rounded-3xl bg-[#1a1a1a]  overflow-hidden  font-extrabold  tracking-wider  shadow-[inset_0_0_30px_rgba(0,0,0,1)]">Merge PDF</h2>
